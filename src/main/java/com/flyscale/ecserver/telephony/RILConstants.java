...
*/
    ...
    int RIL_REQUEST_GET_IMS_CURRENT_CALLS = RIL_SPRD_REQUEST_BASE + 3;
    int RIL_REQUEST_SET_IMS_VOICE_CALL_AVAILABILITY = RIL_SPRD_REQUEST_BASE + 4;
    int RIL_REQUEST_GET_IMS_VOICE_CALL_AVAILABILITY = RIL_SPRD_REQUEST_BASE + 5;
    int RIL_REQUEST_INIT_ISIM = RIL_SPRD_REQUEST_BASE + 6;

    int RIL_REQUEST_ENABLE_IMS = RIL_SPRD_REQUEST_BASE + 10;
    int RIL_REQUEST_DISABLE_IMS = RIL_SPRD_REQUEST_BASE + 11;
    int RIL_REQUEST_IMS_CALL_REQUEST_MEDIA_CHANGE = RIL_SPRD_REQUEST_BASE + 13;
    int RIL_REQUEST_IMS_CALL_RESPONSE_MEDIA_CHANGE = RIL_SPRD_REQUEST_BASE + 14;
    int RIL_REQUEST_IMS_CALL_FALL_BACK_TO_VOICE = RIL_SPRD_REQUEST_BASE + 18;

    int RIL_REQUEST_SET_IMS_INITIAL_ATTACH_APN = RIL_SPRD_REQUEST_BASE + 19;
    int RIL_REQUEST_QUERY_CALL_FORWARD_STATUS_URI = RIL_SPRD_REQUEST_BASE + 20;
    int RIL_REQUEST_SET_CALL_FORWARD_URI = RIL_SPRD_REQUEST_BASE + 21;
    int RIL_REQUEST_IMS_INITIAL_GROUP_CALL = RIL_SPRD_REQUEST_BASE + 22;
    int RIL_REQUEST_IMS_ADD_TO_GROUP_CALL = RIL_SPRD_REQUEST_BASE + 23;
    int RIL_REQUEST_IMS_SET_CONFERENCE_URI = RIL_SPRD_REQUEST_BASE + 24;


    int RIL_REQUEST_VIDEOPHONE_HANGUP = RIL_SPRD_REQUEST_BASE + 25;
    int RIL_REQUEST_VIDEOPHONE_ANSWER = RIL_SPRD_REQUEST_BASE + 26;
    int RIL_REQUEST_VIDEOPHONE_FALLBACK = RIL_SPRD_REQUEST_BASE + 27;
    int RIL_REQUEST_VIDEOPHONE_STRING = RIL_SPRD_REQUEST_BASE + 28;
    int RIL_REQUEST_VIDEOPHONE_LOCAL_MEDIA = RIL_SPRD_REQUEST_BASE + 29;
    int RIL_REQUEST_VIDEOPHONE_RECORD_VIDEO = RIL_SPRD_REQUEST_BASE + 30;
    int RIL_REQUEST_VIDEOPHONE_RECORD_AUDIO = RIL_SPRD_REQUEST_BASE + 31;
    int RIL_REQUEST_VIDEOPHONE_SET_VOICERECORDTYPE = RIL_SPRD_REQUEST_BASE + 32;
    int RIL_REQUEST_VIDEOPHONE_TEST = RIL_SPRD_REQUEST_BASE + 33;


    int RIL_REQUEST_GET_CURRENT_VIDEOCALLS = RIL_SPRD_REQUEST_BASE + 34;
    int RIL_REQUEST_VIDEOPHONE_CONTROL_AUDIO = RIL_SPRD_REQUEST_BASE + 35;
    int RIL_REQUEST_VIDEOPHONE_CONTROL_IFRAME = RIL_SPRD_REQUEST_BASE + 36;
    int RIL_REQUEST_MBBMS_GSM_AUTHEN = RIL_SPRD_REQUEST_BASE + 37;
    int RIL_REQUEST_MBBMS_USIM_AUTHEN = RIL_SPRD_REQUEST_BASE + 38;
    int RIL_REQUEST_MBBMS_SIM_TYPE = RIL_SPRD_REQUEST_BASE + 39;
    int RIL_REQUEST_GPRS_ATTACH = RIL_SPRD_REQUEST_BASE + 40;
    int RIL_REQUEST_GPRS_DETACH = RIL_SPRD_REQUEST_BASE + 41;
    int RIL_REQUEST_GET_SIM_CAPACITY = RIL_SPRD_REQUEST_BASE + 42;
    int RIL_REQUEST_QUERY_COLP = RIL_SPRD_REQUEST_BASE + 43;
    int RIL_REQUEST_QUERY_COLR = RIL_SPRD_REQUEST_BASE + 44;
    int RIL_REQUEST_MMI_ENTER_SIM = RIL_SPRD_REQUEST_BASE + 45;
    int RIL_REQUEST_END_ALL_CONNECTIONS = RIL_SPRD_REQUEST_BASE + 46;
    int RIL_REQUEST_GET_REMAIN_TIMES = RIL_SPRD_REQUEST_BASE + 47;
    int RIL_REQUEST_SET_CMMS = RIL_SPRD_REQUEST_BASE + 48;
    int RIL_REQUEST_SIM_POWER = RIL_SPRD_REQUEST_BASE + 49;
    int RIL_REQUEST_SEND_AT = RIL_SPRD_REQUEST_BASE + 50;
    int RIL_REQUEST_SET_SPEED_MODE = RIL_SPRD_REQUEST_BASE + 51;
    int RIL_REQUEST_SET_SIM_SLOT_CFG = RIL_SPRD_REQUEST_BASE + 52;
    int RIL_REQUEST_GET_SIMLOCK_REMAIN_TIMES = RIL_SPRD_REQUEST_BASE + 53;//for sim lock
    /* SPRD: add for LTE-CSFB to handle CS fall back of MT call @{*/
    int RIL_REQUEST_CALL_CSFALLBACK_ACCEPT = RIL_SPRD_REQUEST_BASE + 54;
    int RIL_REQUEST_CALL_CSFALLBACK_REJECT = RIL_SPRD_REQUEST_BASE + 55;
    /* @} */
    /* SPRD: add for priority network mode*/
    int RIL_REQUEST_SET_PRIORITY_NETWORK_MODE = RIL_SPRD_REQUEST_BASE + 56;
    int RIL_REQUEST_GET_PRIORITY_NETWORK_MODE = RIL_SPRD_REQUEST_BASE + 57;
    /* @} */
    /**
     * SPRD: For WIFI get BandInfo report from modem,
     * BRCM4343+9620, Zhanlei Feng added. 2014.06.20
     * START
     */
    int RIL_REQUEST_GET_BAND_INFO = RIL_SPRD_REQUEST_BASE+58;
    int RIL_REQUEST_SWITCH_BAND_INFO_REPORT = RIL_SPRD_REQUEST_BASE+59;
    int RIL_REQUEST_SWITCH_3_WIRE = RIL_SPRD_REQUEST_BASE+60;
    int RIL_REQUEST_SWITCH_BT = RIL_SPRD_REQUEST_BASE+61;
    int RIL_REQUEST_SWITCH_WIFI = RIL_SPRD_REQUEST_BASE+62;
    /**
     * SPRD: For WIFI get BandInfo report from modem,
     * BRCM4343+9620, Zhanlei Feng added. 2014.06.20
     * END
     */
    int RIL_REQUEST_GET_IMS_BEARER_STATE = RIL_SPRD_REQUEST_BASE + 66;
    /* SPRD: Bug 625003 Add for Reliance simlock */
    int RIL_REQUEST_GET_SIMLOCK_STATUS = RIL_SPRD_REQUEST_BASE + 67;
    int RIL_REQUEST_GET_HD_VOICE_STATE = RIL_SPRD_REQUEST_BASE + 501;

    int RIL_REQUEST_DIAL_EMERGENCY_CALL = RIL_SPRD_REQUEST_BASE + 28;



    // set ps active phone id to rilproxy (for svlte)
    int RIL_REQUEST_SET_RILPROXY_LTE_ENABLE = RIL_SPRD_REQUEST_BASE + 100;
    ...
    int RIL_UNSOL_SIM_PS_REJECT = RIL_SPRD_UNSOL_RESPONSE_BASE + 14;
    // for lte ps status report (for svlte)
    int RIL_UNSOL_LTE_READY = RIL_SPRD_UNSOL_RESPONSE_BASE + 15;
    int RIL_UNSOL_FDN_ENABLE = RIL_SPRD_UNSOL_RESPONSE_BASE + 17;
    int RIL_UNSOL_CALL_CSFALLBACK = RIL_SPRD_UNSOL_RESPONSE_BASE + 18;//SPRD:add for LTE-CSFB to handle CS fall back of MT call
    /**
     * SPRD: For WIFI get BandInfo report from modem,
     * BRCM4343+9620, Zhanlei Feng added. 2014.06.20
     * START
     */
    int RIL_UNSOL_BAND_INFO = RIL_SPRD_UNSOL_RESPONSE_BASE + 19;
    /**
     * SPRD: For WIFI get BandInfo report from modem,
     * BRCM4343+9620, Zhanlei Feng added. 2014.06.20
     * END
     */
    int RIL_UNSOL_CALL_CSFALLBACK_FINISH = RIL_SPRD_UNSOL_RESPONSE_BASE + 20;//SPRD:add for LTE-CSFB to handle CS fall back of MT call
    /* SPRD: @{*/
    int RIL_UNSOL_SMS_ETWS_CMAS = RIL_SPRD_UNSOL_RESPONSE_BASE + 21;
    int RIL_UNSOL_RESPONSE_IMS_CALL_STATE_CHANGED = RIL_SPRD_UNSOL_RESPONSE_BASE + 23;
    int RIL_UNSOL_CONN_IMSEN = RIL_SPRD_UNSOL_RESPONSE_BASE + 25;
}
