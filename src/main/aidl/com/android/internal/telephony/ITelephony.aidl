...
interface ITelephony {
     ...
     */
     ...
     /**
      ...
      void setSimStandby(int phoneId, boolean standby);
    ...
    String getPnnHomeName(String callingPackage);
    String getSpnFromSimRecords(String callingPackage);
    /* @} */
    boolean isInternationalNetworkRoaming();
    Bundle getCellLocationForPhone(int phoneId);
    // SPRD: Add for CMCC DM VoLTE switch for bug637734.
    void setVoLTEState(int value);
    void queryVoLTEState();
