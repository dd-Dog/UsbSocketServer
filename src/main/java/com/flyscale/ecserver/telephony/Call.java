...
package com.flyscale.ecserver.telephony;
...
public final class Call implements Parcelable {
    ...
    public static class Capabilities {
        ...
        public static final int HIGH_DEF_AUDIO = 0x00000100; /* SPRD: add for HIGH_DEF_AUDIO */
        public static final int CAPABILITY_SEPARATE_FROM_CONFERENCE = 0x00001000;
        public static final int CAPABILITY_IMS_CONFERENCE = 0x00002000;
        public static final int ALL = HOLD | SUPPORT_HOLD | MERGE_CALLS | SWAP_CALLS | ADD_CALL
                | RESPOND_VIA_TEXT | MUTE | GENERIC_CONFERENCE | HIGH_DEF_AUDIO|CAPABILITY_SEPARATE_FROM_CONFERENCE
                | CAPABILITY_IMS_CONFERENCE;
    }
    ...
    public static final Map<Integer, String> STATE_MAP = ImmutableMap.<Integer, String>builder()
            .put(State.ACTIVE, "ACTIVE")
            .put(State.CALL_WAITING, "CALL_WAITING")
            .put(State.DIALING, "DIALING")
            .put(State.REDIALING, "REDIALING")
            .put(State.IDLE, "IDLE")
            .put(State.INCOMING, "INCOMING")
            .put(State.ONHOLD, "ONHOLD")
            .put(State.INVALID, "INVALID")
            .put(State.DISCONNECTING, "DISCONNECTING")
            .put(State.DISCONNECTED, "DISCONNECTED")
            .put(State.CONFERENCED, "CONFERENCED")
            .build();
    ...
    private SortedSet<Integer> mChildCallIds = new TreeSet();
    ...
    public Call(Call call) {
        ...
        mIsVideo = call.mIsVideo;
        mIsIncoming = call.mIsIncoming;
        mConnectRealTime  = call.mConnectRealTime;
        /* @} */
    }
    ...
    public void setPhoneId(int phoneId) {
        mIdentification.setPhoneId(phoneId);
    }

    public int getPhoneId() {
        return mIdentification.getPhoneId();
    }
    /* @} */
    ...
    private long mConnectRealTime = 0;

    public void setConnectRealTime(long connectRealTime) {
        mConnectRealTime = connectRealTime;
    }

    public long getConnectRealTime() {
        return mConnectRealTime;
    }
    /* @} */
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        /* SPRD: add for Universe UI @ { */
        dest.writeValue(mIsVideo);
        dest.writeValue(mIsIncoming);
        dest.writeLong(getConnectRealTime());
        /* @} */
    }
    ...
    private Call(Parcel in) {
        ...
        /* SPRD: add for Universe UI @ { */
        mIsVideo = (Boolean) in.readValue(Boolean.class.getClassLoader());
        mIsIncoming = (Boolean) in.readValue(Boolean.class.getClassLoader());
        mConnectRealTime = in.readLong();
        /* @} */
    }
    ...
    public String toString() {
        return Objects.toStringHelper(this)
                ...
                /* SPRD: add for Universe UI @ { */
                .add("mIsVideo", mIsVideo)
                .add("mIsIncoming", mIsIncoming)
                .add("mConnectRealTime", mConnectRealTime)
                /* @} */
                .toString();
    }
    ...
    public boolean enableRecord(){
        return (mState == State.ACTIVE || mState == State.ONHOLD || mState == State.CONFERENCED);
    }

    public boolean enableAddCall(){
        return (mState == State.ACTIVE || mState == State.ONHOLD || mState == State.CONFERENCED);
    }
